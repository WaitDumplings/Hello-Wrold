...
- [Llama2](#llama2)
  ...
  - [3. 准备模型](#3-准备模型)
      ...
      - [3.3 编译模型(分布式)](#33-编译模型(分布式))
      - [3.4 编译程序(C++版本)](#34-编译程序(C++版本))
  - [4. 例程测试](#4-例程测试)
...
│       ├─ Llama2-7B_int8.bmodel
│       └─ Llama2-7B_int4.bmodel
├── tools                                #自行编译模型时会需要的工具
...
同时将LIBSOPHON指定到tools/soc-sdk路径下
